...
class NonWearingDetector(object):
    ...
    def __init__(self, input: {Wearable, Experiment}):
        ...
        elif type(input) is data.wearable.Wearable:
    ...
    def detect_non_wear(self,
        ...
        """
        Detects periods of device non-wear in the Wearable.data df according to the selected non-wear strategy / algorithm. 
        Labels non-wear in the boolean wearing_col
