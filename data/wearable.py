import pandas as pd
from .preprocessing import RawProcessing
from utils import Diary, CGM, misc
...
class Wearable(object):
    ...
    def __init__(self, input):
        ...
        :init: setting experiment_dat_col, diary_col 
        """
        self.data = None
        ...
        elif isinstance(input, RawProcessing):
    ...
    def __read_preprocessing_obj(self, input):
        ...
        # Activity Info
        self.activitycols = input.internal_activity_cols #  ["hyp_act_x", "hyp_act_y", "hyp_act_z"]
    ...
    def fill_no_activity(self, value):
        ...
        self.data.fillna({self.get_activity_col(): value}, inplace=True)
